...
class _ChatPageState extends State<ChatPage> {
  ...
  final TextEditingController _chatSearchTextController = TextEditingController();
        ...
        children: [
          ...
          Container(
            ...
            child: ListTile(
              ...
              leading: CircleAvatar(child: Text('A'), radius: 23,),
              trailing: Column(
                mainAxisSize: MainAxisSize.max,
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text('17/3/2020', style: TextStyle(color: primarySwatch, fontSize: 10),),
                  SizedBox(height: 5,),
                  CircleAvatar(radius: 10, backgroundColor: primarySwatch , child: Text('20', style: TextStyle(color: Colors.white, fontSize: 10),),)
                ],
              ),
            ),
          )
