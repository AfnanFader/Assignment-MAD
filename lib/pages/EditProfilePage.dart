          ...
          child: Stack(
            children: [
                        ...
                        Padding(
                          ...
                          child: CircleAvatar(
                            ...
                            child: CircleAvatar(
                              ...
                              child: Text('M', style: TextStyle(fontWeight: FontWeight.bold, color: primarySwatch, fontSize: 30),),
                            ),
                          ),
                        ),
                        FlatButton(
                          onPressed: () {},
                          child: Text('Change Picture', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue[500]),),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              isDense: true,
                              labelText: 'Location',
                              labelStyle: TextStyle(fontSize: 23, fontWeight: FontWeight.normal),
                              floatingLabelBehavior: FloatingLabelBehavior.always,
                              hintText: 'No 23, USJ Height 5,\nJalan Padu Gila, Shah Alam,\n42300, Selangor',
                              enabledBorder: _borderDecoration,
                              focusedBorder: _borderDecoration
                            ),
                          ),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                Positioned(
                                  child: Text('Gender',style: TextStyle(fontSize: 17, fontWeight: FontWeight.normal)),
                                ),
                                Padding(
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Card(
                                          shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(15),
                                            side: BorderSide(color: _isMale?Colors.blue:Colors.white,width: 2)
                                          ),
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Card(
                                          shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(15),
                                            side: BorderSide(color: _isMale?Colors.white:Colors.blue,width: 2)
                                          ),
                              ...
                              children: [
                                RaisedButton(
                                  ...
                                  child: Container(
                                    ...
                                    height: 30,
                                    child: Center(
                                      child: Text('Discard', style: TextStyle(color: primarySwatch, fontWeight: FontWeight.bold, fontSize: 17),),
                                    ),
                                  ),
                                ),
                                SizedBox(width: 15,),
              ...
              Positioned(
                ...
                left: 10,
                child: IconButton(
                  icon: Icon(Icons.keyboard_arrow_left, color:primarySwatch ,size: 40,),
