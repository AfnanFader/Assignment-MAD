  ...
  Widget _changeLoginSignUp() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            _isLogin ? 'New to Petdopt?' : 'Already have an Account?',
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
              icon: Icon(
                _obscurePassword2 ? Icons.lock : Icons.lock_open,
                color: Colors.white,
                size: 18,
              ),
              onPressed: () =>
        ...
        onPressed: () {
          if (_registerFormKey.currentState.validate() && _isMale != null) {
            _registerScaffoldKey.currentState
                .showSnackBar(_registerSnackBarStatus(prov));
